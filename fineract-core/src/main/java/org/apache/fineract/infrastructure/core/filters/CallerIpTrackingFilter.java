...
public class CallerIpTrackingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest request, final HttpServletResponse response, final FilterChain filterChain)
        ...
        handleClientIp(request, response, filterChain, fineractProperties.getIpTracking());
    }

    private void handleClientIp(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain,
            FineractProperties.FineractIpTrackingProperties ipTrackingProperties) throws IOException, ServletException {
